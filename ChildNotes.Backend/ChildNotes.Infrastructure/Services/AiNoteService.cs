...
- 12 小时制时间解析（重要，禁止场景语义推断 AM/PM）：
  - 仅当用户显式说"上午/早上/中午/下午/晚上/夜里/凌晨"等时段词时，才据此判断 AM/PM
  - 无时段修饰时按字面解析：5 点=05:00，8 点=08:00，不要基于"吃奶/睡觉"等场景语义推断成下午
  - 示例："五点半吃了奶粉" → time="05:30"（不是 17:30）
  - 示例："8点睡了一觉" → time="08:00"（不是 20:00）
  - 示例："晚上8点睡了一觉" → time="20:00"（有"晚上"修饰才转 PM）

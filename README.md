...
├── docs/                             # 当前文档中心（design/development/release/archive）
...
- 组件规范：[`docs/design/components.md`](docs/design/components.md)
- 架构说明：[`docs/development/architecture.md`](docs/development/architecture.md)
- 后端开发：[`docs/development/backend.md`](docs/development/backend.md)
- AI 功能：[`docs/development/ai.md`](docs/development/ai.md)
- 发布清单：[`docs/release/app-store.md`](docs/release/app-store.md)
...
- 文档新增时优先放入 `docs/design/`、`docs/development/` 或 `docs/release/`；历史文档移入 `docs/archive/`。

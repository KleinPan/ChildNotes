...
internal sealed class LanguageResourceDictionary : ResourceDictionary
{
    ...
    private void FillZhHans()
    {
        ...
        this["Login_Email"] = "邮箱";
        this["Login_EmailPlaceholder"] = "请输入邮箱";
        this["Login_Code"] = "验证码";
        this["Login_CodePlaceholder"] = "请输入验证码";
        this["Login_SendCode"] = "发送验证码";
        this["Login_ResendIn"] = "{0}s 后重发";
        this["Login_InvalidEmail"] = "请输入有效的邮箱";
        this["Login_InvalidCode"] = "请输入验证码";
        this["Login_ServerSettings"] = "服务器设置";
        this["Login_ServerSettingsToggle"] = "服务器设置 ▼";
        this["Login_ServerUrlLabel"] = "服务器地址（留空=纯本地模式）";
        this["Login_ServerUrlHint"] = "登录前先填地址，账号会同步到后端服务器";
        this["Login_LoginBtn"] = "登 录";
        this["Login_LocalMode"] = "未登录可用本地离线模式 · 登录后开启云同步";
        // LoginViewModel
    ...
    private void FillEn()
    {
        ...
        this["Login_EmailPlaceholder"] = "Enter email";
        this["Login_Code"] = "Code";
        this["Login_CodePlaceholder"] = "Enter code";
        this["Login_SendCode"] = "Send code";
        this["Login_ResendIn"] = "Resend in {0}s";
        this["Login_InvalidEmail"] = "Please enter a valid email";
        this["Login_InvalidCode"] = "Please enter the code";
        ...
        this["Login_ServerUrlHint"] = "Fill URL before login to sync account to server";
        this["Login_LoginBtn"] = "Log In";
        this["Login_LocalMode"] = "Offline mode available without login · Login enables cloud sync";

...
foodName(complementary专用，食物名称如"南瓜泥"/"蛋黄"/"米粉"；若一顿饭含多种食材，用顿号连接全部食材如"米粉、肝粉、肉泥、核桃油、香蕉",不要拆成多条), foodTypes(complementary专用，食材类型数组如["蔬菜"]),
...
示例输入："11点吃米粉，肝粉，肉泥，核桃油，香蕉"
示例输出：[{"recordType":"complementary","foodName":"米粉、肝粉、肉泥、核桃油、香蕉","foodTypes":["主食","肉蛋","水果"],"time":"11:00","summary":"辅食 米粉等5种","confidence":0.9}]
